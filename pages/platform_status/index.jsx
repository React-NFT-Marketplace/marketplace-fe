...
const Platform_status = () => {
  return (
    <div>
      <Meta title="Platform Status || MotM | NFT Marketplace" />
      <div className="pt-[5.5rem] lg:pt-24">
        {/* <!-- Page Title --> */}

        <ImageTitle
          text="MotM System Status"
                ...
                <div className="flex items-center justify-between py-4 px-5">
                  <div className="flex items-center space-x-2">
                    ...
                    <span
                      ...
                      data-tippy-content="Setting your asset as explicit and sensitive content, like pornography and other not safe for work (NSFW) content, will protect users with safe search while browsing MotM."
                    >
                      <svg
